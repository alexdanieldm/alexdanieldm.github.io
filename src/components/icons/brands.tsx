/**
 * @fileoverview Brand and social marks.
 *
 * Grouped in one file rather than split across fifteen: each of these is a
 * viewBox and a path, there is no behaviour to isolate, and a directory of
 * fifteen four-line files is harder to scan than this is.
 *
 * Everything draws in `currentColor`. The source files these came from were
 * hard-coded `fill="white"`, which is why the comps had to reach for
 * `filter: brightness(0)` to put one on a coral background.
 */
...
/** Drawn here rather than using the official mark, so it sits on the same weight as its neighbours. */
export const GraphQLIcon = (props: IconProps) => (
  <Icon {...props} viewBox="0 0 48 48">
    <path
      d="M24 6 L39 15 V33 L24 42 L9 33 V15 Z"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.4"
    />
    <circle cx="24" cy="6" r="3.8" />
    <circle cx="39" cy="15" r="3.8" />
    <circle cx="39" cy="33" r="3.8" />
    <circle cx="24" cy="42" r="3.8" />
    <circle cx="9" cy="33" r="3.8" />
